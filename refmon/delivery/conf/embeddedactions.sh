...
PID=0
OPTIONS="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=43479 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
...
check_status() {
  ...
  s=`ps -e -o pid,cmd | grep refmon- | grep jar | grep -v grep | tail -n 1 | awk '{print $1}'`
